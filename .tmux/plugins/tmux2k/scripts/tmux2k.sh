...
IFS=' ' read -r -a lplugins <<<"$(get_tmux_option '@tmux2k-left-plugins' 'git cpu ram kubernetes')"
...
set_theme() {
    ...
    "onedark")
        ...
        ;;
    "spaceduck")
        bg_main=$(get_tmux_option "@tmux2k-bg-main" '#0f111b')
        bg_alt=$(get_tmux_option "@tmux2k-bg-alt" '#353b45')
        black=$(get_tmux_option "@tmux2k-black" '#000000')
        white=$(get_tmux_option "@tmux2k-white" '#ffffff')
        red=$(get_tmux_option "@tmux2k-red" '#e33400')
        light_red=$(get_tmux_option "@tmux2k-light-red" '#e39400')
        green=$(get_tmux_option "@tmux2k-green" '#5ccc96')
        light_green=$(get_tmux_option "@tmux2k-light-green" '#5ccc96')
        blue=$(get_tmux_option "@tmux2k-blue" '#00a3cc')
        light_blue=$(get_tmux_option "@tmux2k-light-blue" '#00a3cc')
        yellow=$(get_tmux_option "@tmux2k-yellow" '#f2ce00')
        light_yellow=$(get_tmux_option "@tmux2k-light-yellow" '#e39400')
        purple=$(get_tmux_option "@tmux2k-purple" '#7a5ccc')
        light_purple=$(get_tmux_option "@tmux2k-light-purple" '#b3a1e6')
        ;;
    "rosepine")
        bg_main=$(get_tmux_option "@tmux2k-bg-main" '#191725')
        bg_alt=$(get_tmux_option "@tmux2k-bg-alt" '#353b45')
        black=$(get_tmux_option "@tmux2k-black" '#26233a')
        white=$(get_tmux_option "@tmux2k-white" '#e0def4')
        red=$(get_tmux_option "@tmux2k-red" '#eb6f92')
        light_red=$(get_tmux_option "@tmux2k-light-red" '#eb6f92')
        green=$(get_tmux_option "@tmux2k-green" '#5ccc96')
        light_green=$(get_tmux_option "@tmux2k-light-green" '#5ccc96')
        blue=$(get_tmux_option "@tmux2k-blue" '#9ccfd8')
        ...
        ;;
    "ayu")
        bg_main=$(get_tmux_option "@tmux2k-bg-main" '#0B0E14')
        bg_alt=$(get_tmux_option "@tmux2k-bg-alt" '#0F131A')
        black=$(get_tmux_option "@tmux2k-black" '#000080')
        white=$(get_tmux_option "@tmux2k-white" '#BFBDB6')
        red=$(get_tmux_option "@tmux2k-red" '#F26D78')
        light_red=$(get_tmux_option "@tmux2k-light-red" '#F07178')
        green=$(get_tmux_option "@tmux2k-green" '#AAD94C')
        light_green=$(get_tmux_option "@tmux2k-light-green" '#AAD94C')
        blue=$(get_tmux_option "@tmux2k-blue" '#73B8FF')
        light_blue=$(get_tmux_option "@tmux2k-light-blue" '#73B8FF')
        yellow=$(get_tmux_option "@tmux2k-yellow" '#E6B450')
        light_yellow=$(get_tmux_option "@tmux2k-light-yellow" '#E6B450')
        purple=$(get_tmux_option "@tmux2k-purple" '#D2A6FF')
        light_purple=$(get_tmux_option "@tmux2k-light-purple" '#D2A6FF')
        ;; 
    "tokyonight")
        bg_main=$(get_tmux_option "@tmux2k-bg-main" '#1f2335')
        bg_alt=$(get_tmux_option "@tmux2k-bg-alt" '#1f2335')
        black=$(get_tmux_option "@tmux2k-black" '#000080')
        white=$(get_tmux_option "@tmux2k-white" '#c0caf5')
        red=$(get_tmux_option "@tmux2k-red" '#c53b53')
        light_red=$(get_tmux_option "@tmux2k-light-red" '#ff757f')
        green=$(get_tmux_option "@tmux2k-green" '#c3e88d')
        light_green=$(get_tmux_option "@tmux2k-light-green" '#c3e88d')
        blue=$(get_tmux_option "@tmux2k-blue" '#7aa2f7')
        light_blue=$(get_tmux_option "@tmux2k-light-blue" '#7dcfff')
        yellow=$(get_tmux_option "@tmux2k-yellow" '#ff9e64')
        light_yellow=$(get_tmux_option "@tmux2k-light-yellow" '#ffc777')
        purple=$(get_tmux_option "@tmux2k-purple" '#9d7cd8')
        light_purple=$(get_tmux_option "@tmux2k-light-purple" '#bb9af7')
         ;;
    esac
